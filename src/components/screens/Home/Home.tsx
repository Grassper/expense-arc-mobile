        ...
        <Styled.Container>
            ...
            <Styled.DashboardContainer>
                <Styled.DashboardWrapper>
                    ...
                    <Styled.MainText>
                        $ {millify(home.budgetConsumed)}
                    </Styled.MainText>
                    <Styled.BudgetContainer>
                        <Styled.Text>
                            of $ {millify(home.budget)} budgeted
                        </Styled.Text>
                        <Styled.PencilIcon
                    ...
                    <Styled.PercentContainer>
                        <Styled.BarContainer>
                            <Styled.ConsumedBar
                                width={
                                    Math.ceil(
                                        (home.budgetConsumed / home.budget) *
                                            100
                                    ) || 0
                                }
                            />
                        ...
                        <Styled.Text>
                            {Math.ceil(
                                (home.budgetConsumed / home.budget) * 100
                            ) || 0}
                            %
                        </Styled.Text>
                    </Styled.PercentContainer>
